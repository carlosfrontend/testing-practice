...
describe("\ncaesarCipher function: takes a string and a shift factor and returns it with each character “shifted”.", () => {
  ...
  test("caesarCipher('The user name in The Odin Project is: _odinite', 3) should return 'Wkh xvhu qdph lq Wkh Rglq Surmhfw lv: _rglqlwh'", () => {
    expect(
      caesarCipher("The user name in The Odin Project is: _odinite", 3)
    ).toMatch(/^Wkh xvhu qdph lq Wkh Rglq Surmhfw lv: _rglqlwh$/);
  });
});
